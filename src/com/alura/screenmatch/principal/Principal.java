...
public class Principal {
    public static void main(String[] args) {
        ...
        // Listas
        var peliculaDeBruno = new Pelicula("El señor de los anillos", 2001); // var es igual a poner "Pelicula"
        peliculaDeBruno.setDuracionEnMinutos(180);

        ArrayList<Pelicula> listaDePeliculas = new ArrayList<>(); //ArrayList<E> | <E> = Tipo de dato
        listaDePeliculas.add(peliculaDeBruno);
        listaDePeliculas.add(miPelicula);
        listaDePeliculas.add(otraPelicula);

        System.out.println("Tamaño de la lista: " + listaDePeliculas.size()); // Tamaño de la lista
        System.out.println("La primera pelicula es: " + listaDePeliculas.get(0).getNombre()); // Primer elemento  de la lista | nombre
